...
public static class DatabaseInitializer
{
    ...
    private static async Task SeedContentAsync(NpgsqlConnection connection)
    {
        ...
        var services = new[]
        {
            new { Id = Guid.NewGuid(), Slug = "derecho-penal", Name = "Derecho penal", ShortDescription = "Defensa técnica, inmediata y estratégica en cada etapa del proceso.", LongDescription = "Acompañamiento integral desde la primera consulta, análisis de riesgos, diseño de la teoría del caso y representación durante todo el proceso penal.", Icon = "Shield", Accent = "01", Order = 1, Gallery = new[] { "/images/services/penal-1.webp", "/images/services/penal-2.webp", "/images/services/penal-3.webp", "/images/services/penal-4.webp" } },
            new { Id = Guid.NewGuid(), Slug = "derecho-familia", Name = "Familia", ShortDescription = "Soluciones humanas y firmes para decisiones que cambian la vida.", LongDescription = "Asesoría en divorcios, alimentos, tenencia, régimen de visitas y acuerdos familiares, con claridad jurídica y sensibilidad personal.", Icon = "Users", Accent = "02", Order = 2, Gallery = new[] { "/images/services/familia-1.webp", "/images/services/familia-2.webp", "/images/services/familia-3.webp", "/images/services/familia-4.webp" } },
            new { Id = Guid.NewGuid(), Slug = "derecho-civil", Name = "Civil y contratos", ShortDescription = "Prevención de conflictos y defensa de sus derechos patrimoniales.", LongDescription = "Redacción y revisión de contratos, obligaciones, cobros, propiedad y controversias civiles con una visión preventiva y práctica.", Icon = "FileText", Accent = "03", Order = 3, Gallery = new[] { "/images/services/civil-1.webp", "/images/services/civil-2.webp", "/images/services/civil-3.webp", "/images/services/civil-4.webp" } },
