    ...
    <PageFrame active="/perfil" profile={profile} site={site}>
      <section className="relative overflow-hidden bg-[#11100e] px-5 py-16 text-white sm:px-8 sm:py-24 lg:px-12">
        ...
        <div className="relative mx-auto grid max-w-[1344px] items-end gap-12 lg:grid-cols-[1.05fr_.95fr]">
          ...
          <div className="relative mx-auto aspect-[2/3] w-full max-w-[500px] overflow-hidden rounded-t-[11rem] border border-white/12 bg-[#24201c]"><img src={assetUrl(profile.heroImageUrl)} alt={profile.fullName} className="h-full w-full object-contain object-bottom" /><div className="absolute inset-x-0 bottom-0 h-32 bg-gradient-to-t from-[#11100e] to-transparent" /></div>
        </div>
      </section>
